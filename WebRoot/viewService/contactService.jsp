...
<html>
						 ...
						 <ul class="am-list admin-sidebar-list">
						    ...
						    <li class="admin-parent">
						      ...
						      <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav2">
						        ...
						        <li><a href="" class="am-cf" id="pingjia"> 评价管理</span></a></li>
 ...
 <main class="app-content" style="width: 80%;height: 70%;  margin:10px ;">
      <div class="app-title" >
        <div >
      ...
      <div class="row" >
        ...
        <div class="col-md-9" style="width:100%;height:83%;overflow-y:scroll;">
          <div class="tile">
            <div class="mailbox-controls">
            </div>
            <div class="table-responsive mailbox-messages" align="left">
              	 
                  <form action="sentNews" method="post" >
                   <div class="form-group">
                    <label for="exampleSelect1">选择客服</label>
                    <select class="form-control" style="height:40px;font-size:14px;"  name="rname">
                    <c:forEach var="user" items="${users}">
                    	<option   value="${user.username}">${user.username}(编号:${user.phone})</option>
                    </c:forEach>                   
                    </select>
                  </div>
                   <div class="mailbox-controls">
                    ...
                    <label class="form-control-label"  for="inputSuccess1" id="titleText">标题：</label>
                  	<input class="form-control is-valid" id="title" type="text" name="title" style="font-size:14px;">       	 
                    </div>
                    <div class="form-group has-success">
                    <label class="form-control-label" for="inputSuccess1" id="messageText" >内容：</label>
