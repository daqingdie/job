...
<html lang="zh-CN"><head>
  ...
  <th>操作</th>
      ...
      <tr>
      <th><input type="checkbox"></th>                                       
<th>${recruit.rec_id}</th>
  <th>${recruit.rec_name}</th>
  <th>${recruit.rec_number}</th>
  <th>${recruit.rec_sex}</th>
  <th>${recruit.rec_describe}</th>
  <th>${recruit.rec_city}</th>
  <th>${recruit.rec_pay}</th>
                <th>
                </th>
              </tr>
              </tbody>
