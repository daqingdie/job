...
<th>${j.job_id}</th>
  ...
  <th>
                  <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                      <button onclick="window.location.href = '<%=basePath %>jobInfo?job_id=${j.job_id}'" type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary" data-toggle="modal" data-target="#myModal5"><span class="am-icon-pencil-square-o"></span>详细信息</button>
                    </div>
                  </div>
                </th>
              </tr>
            ...
            <div class="am-cf">
              <font size="2">共 1 页</font> <font size="2">第 
            1 页</font>
              <div class="am-fr">
