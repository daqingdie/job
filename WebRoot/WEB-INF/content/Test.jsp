						 ...
						 <ul class="am-list admin-sidebar-list">
						    ...
						    <li class="admin-parent">
						      ...
						      <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav2">
						        ...
						        <li><a href="" class="am-cf"> 求职管理</span></a></li>
						        <li><a href="" class="am-cf"> 评价管理</span></a></li>
						        <li><a href="" class="am-cf"> 消息管理</span></a></li>
						      </ul>
						    </li>
						    <li class="admin-parent">
						      ...
						      <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav5">
						        <li><a href="" class="am-cf"> 个人信息</a></li>
						        <li><a href="">设置</a></li>   
						      </ul>
						    </li>
						  </ul>
            ...
            ${page.pageNow} 页</font>
              <div class="am-fr">
                <ul class="am-pagination">
                  ...
                  <li class="am-active"><a href="?pageNow=1">1</a></li>
