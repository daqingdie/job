				...
				<div class="am-g">
						...
						<div class="card-box" >
							<div  id="pie1" style="width: 100%;height: 80%; " ><br>
									<h1 class="logo" align="center">修改信息</h1><br>
									<form action="updateUser?id=${oldUser.id}" method="post" name="user" id="ListForm">
                                <div class="form-group" style="text-align:center;">
                                    <label id="text2">用户名：</label>
                                    <input type="text" name="username" id="username" value="${oldUser.username}" class="form-control" style="width: 300px; margin:0 auto;">
                                </div><br><br>
                                 <div class="form-group" style="text-align:center;">
                                    <label id="text3">手机号：</label>
                                    <input type="text" name="phone" id="phone" value="${oldUser.phone}" class="form-control"  style="width: 300px; margin:0 auto;" >
                                </div><br>
		...
		$(document).ready(function(){
			...
			$("#submit").click(function(){
					  if ($("#username").val() == "") {
					   ...
					   alert("用户名不能小于3位!");
					   return false;
					  }else if (!pattern.test($("#phone").val())&&power!="2") {
					   alert("手机号码格式错误");
					   return false;
					  }
					 return true;
