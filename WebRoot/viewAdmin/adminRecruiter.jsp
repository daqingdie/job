            ...
            <div class="tile-body">
              ...
              <table class="table table-hover table-bordered" id="sampleTable">
				...
				<tr>
				   		...
				   		<td>${recruit.rec_name}</td>
				   		<td >${recruit.rec_number}</td>
				   		<td >${recruit.rec_sex}</td>
				   		<td >${recruit.rec_describe}</td>
				   		<td >${recruit.rec_city}</td>
				   		<td >${recruit.rec_pay}</td>
				 
				   		
				   			
				   		<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				   			<a href="adminDeleteRecruiter?id=${recruit.rec_id}" onclick="return del()"><button class="btn btn-info" type="button">删除</button></a></td>
				   	</tr>
				</c:forEach>
                </tbody>
              </table>
