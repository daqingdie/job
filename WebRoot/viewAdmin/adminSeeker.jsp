...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> 求职信息管理</h1>
          <p>求职信息列表</p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>

          <li class="breadcrumb-item active"><a href="#">求职信息管理</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="tile-body">
              ...
              <table class="table table-hover table-bordered" id="sampleTable">
				...
				<tr>
				   		...
				   		<td >${job.job_birth}</td>
				   		<td >${job.job_time}</td>
				   		<td >${job.job_education}</td>
				   		<td >${job.job_phone}</td>
				   		<td >${job.job_introduce}</td>
				 
				   		
				   			
				   		<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				   			<a href="adminDeleteSeeker?id=${job.job_id}" onclick="return del()"><button class="btn btn-info" type="button">删除</button></a></td>
				   	</tr>
				</c:forEach>
                </tbody>
              </table>
